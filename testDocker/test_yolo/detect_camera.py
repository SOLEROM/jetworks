...
for i in indices.flatten():
    ...
    cv2.putText(original, label, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)

# Print relative center of largest detection
if biggest_center:
    rel_x = biggest_center[0] - (w0 // 2)
    rel_y = biggest_center[1] - (h0 // 2)
    print(f"🧭 Largest object center: x={rel_x}, y={rel_y} (camera frame center as 0,0)")
